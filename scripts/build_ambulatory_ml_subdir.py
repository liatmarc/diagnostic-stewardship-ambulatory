...
<title>[ML Demo] Ambulatory Diagnostic Stewardship</title>
<style>
:root {{ --bg:#f8fafc; --fg:#0f172a; --muted:#475569; --card:#ffffff; --accent:#1d4ed8; --warn:#b91c1c; }}
...
.banner {{ background:var(--warn); color:#fff; padding:10px 16px; font-weight:600; text-align:center; }}
a.link {{ color: var(--accent); text-decoration: none; }}
</style></head><body>
<div class='banner'>ML Demo — Predictions (RandomForest) for Ambulatory Classification. Not the rule-based dashboard.</div>
<div class='container'>
  <div class='card' style='margin-bottom:16px;'>
    <div style='display:flex; gap:16px; flex-wrap:wrap; align-items:center;'>
      ...
      <div><a class='link' href='../index.html'>← Back to main (rule-based) dashboard</a></div>  
    </div>
  </div>
